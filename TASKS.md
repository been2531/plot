...
- [x] T15: 프로필 페이지 — 유저 플롯 목록, 팔로워 수, 스크랩 보드
- [x] T16: 크리에이터 후원 링크 필드 — 플롯 생성/편집 시 외부 링크(토스/포스타입) 입력 필드
- [x] T17: 스폰서 핀 UI — 지도 핀에 스폰서 배지 표시 및 외부 링크 아웃 처리
- [x] T18: 어필리에이트 링크 — 핀 상세에서 외부 예약 플랫폼 링크 연동 UI
